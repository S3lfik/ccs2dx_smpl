...
bool BackgroundLayer::initBackground(float speed)
{
	...
	m_hills = ScrollingBg::create("./textures/hills.png", m_scrollingSpeed * 0.1f, m_visibleSize.height * 0.2f);
	this->addChild(m_hills, -4);
	m_trees = ScrollingBg::create("./textures/trees.png", m_scrollingSpeed * 0.5f, m_visibleSize.height * 0.2f);
